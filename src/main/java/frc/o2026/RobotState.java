...
public class RobotState {
  ...
  @Getter @Setter private static boolean hasCoral = false;
  @Getter private static SimulatedArena simArena = new Arena2025Reefscape();
  @Setter @Getter private static Pose3d poseEst = new Pose3d();
  @Setter @Getter private static Pose3d simRealPose = new Pose3d();
  @Setter @Getter private static boolean simIntaking = false;
